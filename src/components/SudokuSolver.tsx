...
export function SudokuSolver() {
  ...
  return (
    <>
      ...
      {loading && (
       /*  <i className="fa-solid fa-spinner fa-spin text-white absolute top-[50%] translate-y-[50%] z-50 text-[50px]"></i> */
       <div className="absolute top-[50%] translate-y-[-50%] z-50">
           <img src={spinner} alt="loading" className="animate-spin" width={60} height={60}/>
       </div>
      )}
      {noSolution && (
